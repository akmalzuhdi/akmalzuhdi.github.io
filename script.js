...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Nov 23, 2020 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Assalamualaikum Wr. Wb", " ", "Aku Akmal Zuhdi pada hari ini Senin, 23 November 2020 dengan sepenuh hati mengucapkan", " ", "<b>Selamat Ulang Tahun Yang ke - 16</b>", " ", "Kepada Desnita Nindy, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari aku", , " ", "Wassalamualakaikum Wr. Wb", " ", "- Akmal Zuhdi, Mas ganteng :)"],
  startDelay: 4000,
  speed: 75,
